...
<link rel="stylesheet" href="css/bootstrap.min.css">
	...
	--dark: #342E37;
	--red: #DB504A;
	--light-red: rgb(235, 131, 131);
	--yellow: #FFCE26;
	--light-yellow: #FFF2C6;
	--orange: #FD7238;
	--light-orange: #FFE0D3;
	--green: green;
	--light-green: rgb(100, 212, 100);
	--violet: violet;
	--light-violet: rgb(215, 173, 215);
}
...
<body>
	...
	<section id="content">
		...
		<li class="dropdown">
<a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-wrench"  style=" padding: 5px; border: 3px solid black; font-size: 20px; margin-left: 620%; ">Settings
<b class="caret"></span></b></a><!--dropdown menu--->	
<ul class="dropdown-menu" style="font-size: 20px; margin-left: 620%; top: 35px; border: 3px solid black;">
<li class=""><a href="logout.php"><span class="glyphicon glyphicon-log-out">Logout</span></a></li>
		...
		<!-- MAIN -->
		<canvas id="container" style="width: 80%; max-width: 80%; margin-left: 4%; margin-top: -400px;"></canvas>
...
/*admin*/
			...
			<div class="panel-body" style="color: red; font-size: 20px;">
			<?php
			$id=$_SESSION['user'];
...
<button class="btn btn-danger btn-flat emp_delete" id="<?php echo $row['user_id']; ?>"><i class="fas fa-trash"></i></button>
<?php
	}
?>	
	 </div>                   
