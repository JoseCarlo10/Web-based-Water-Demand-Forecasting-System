																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td>'.$rows['user_id'].'</td>
																								...
																								<td><a href="delete_users.php?user_del='.$rows['user_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px">Delete</i></a> 
																								<a href="updated_user.php?user_upd='.$rows['user_id'].'" "  class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5" style="padding: 8px;"><i class="ti-settings">Update</i></a>
																									</td></tr>';
